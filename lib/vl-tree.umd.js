(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vl-tree"] = factory(require("vue"));
	else
		root["vl-tree"] = factory(root["Vue"]);
...
module.exports = JSON.parse("{\"name\":\"@sangtian152/virtual-tree\",\"version\":\"0.2.4\",\"private\":false,\"main\":\"lib/vl-tree.common.js\",\"license\":\"MIT\",\"homepage\":\"https://sangtian152.github.io/virtual-tree\",\"keywords\":[\"tree\",\"vl-tree\",\"virtual-tree\",\"vue\",\"虚拟化树控件\"],\"scripts\":{\"dev\":\"vuepress dev docs\",\"build\":\"npm run build:docs && npm run build:lib\",\"lint\":\"vue-cli-service lint\",\"build:docs\":\"vuepress build docs\",\"build:lib\":\"vue-cli-service build --target lib --name vl-tree --dest lib src/index.js\"},\"dependencies\":{\"@sangtian152/stl\":\"^0.1.1\",\"core-js\":\"^3.6.5\",\"lodash-unified\":\"^1.0.2\",\"memoize-one\":\"^6.0.0\"},\"peerDependencies\":{\"vue\":\"^2.6.11\"},\"devDependencies\":{\"@vue/cli-plugin-babel\":\"~4.5.15\",\"@vue/cli-plugin-eslint\":\"~4.5.15\",\"@vue/cli-service\":\"~4.5.15\",\"async-validator\":\"^1.11.5\",\"babel-eslint\":\"^10.1.0\",\"clipboard\":\"^2.0.11\",\"element-ui\":\"^2.15.9\",\"eslint\":\"^6.7.2\",\"eslint-plugin-vue\":\"^6.2.2\",\"sass\":\"^1.53.0\",\"sass-loader\":\"^8.0.2\",\"view-design\":\"^4.7.0\",\"vue-template-compiler\":\"^2.6.11\",\"vuepress\":\"^1.9.7\"},\"eslintConfig\":{\"root\":true,\"env\":{\"node\":true},\"extends\":[\"plugin:vue/essential\",\"eslint:recommended\"],\"parserOptions\":{\"parser\":\"babel-eslint\"},\"rules\":{}},\"browserslist\":[\"> 1%\",\"last 2 versions\",\"Chrome 40.0\",\"ie >= 11\"]}");
...
module.exports = __webpack_require__("2ef0")
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              utils_log.pretty('[' + package_0.name + '] ' + package_0.version, package_0.homepage);
...
var isClient = !external_commonjs_vue_commonjs2_vue_root_Vue_default.a.prototype.$isServer;
var utils_hasOwnProperty = Object.prototype.hasOwnProperty;
function utils_hasOwn(obj, key) {
...
var rAF = function rAF(fn) {
  return isClient ? window.requestAnimationFrame(fn) : setTimeout(fn, 16);
};
...
// CONCATENATED MODULE: ./src/utils/created.js
...
function created_install(vm, Vue) {
  var name = vm.name;
  Vue.component(name, vm);
  Vue.component(camelize("-".concat(name)), vm);
...
var _createNamespace = createNamespace("icon"),
    icon_createComponent = _createNamespace[0],
    bem = _createNamespace[1];

/* harmony default export */ var icon = (icon_createComponent({
  props: {
    name: String,
    node: Object
  },
  ...
  render: function render() {
    ...
    return this.treeSlot.icon ? this.treeSlot.icon({
      node: node,
      data: data
    }) : h("i", {
      "class": bem(this.name)
...
/* harmony default export */ var src_checkbox = (checkbox_createComponent({
  data: function data() {
    return {
      selfModel: false,
      focus: false,
  ...
  methods: {
    ...
    genIcon: function genIcon() {
      var h = this.$createElement;
      return h("span", {
        "class": checkbox_bem('inner')
      });
    },
    genInner: function genInner() {
      var h = this.$createElement;
      var Children = [this.genInput(), this.genIcon()];
      return h("span", {
        "class": [checkbox_bem('input'), {
...
// CONCATENATED MODULE: ./src/tree/tree-node-content.js


var tree_node_content_createNamespace = createNamespace("tree-node"),
    tree_node_content_createComponent = tree_node_content_createNamespace[0],
    tree_node_content_bem = tree_node_content_createNamespace[1];

/* harmony default export */ var tree_node_content = (tree_node_content_createComponent({
  props: {
    node: Object
  },
  inject: ["treeSlot"],
  render: function render() {
    ...
    var node = this.node;
    var data = this.node.data;
    return this.treeSlot.default ? this.treeSlot.default({
      node: node,
      data: data
    }) : h("span", {
      "class": tree_node_content_bem("label")
    }, [node.label]);
  }
}));
...
// CONCATENATED MODULE: ./src/tree/virtual-tree.js

 // constants

var ROOT_TREE_INJECTION_KEY = 'r-tree';
var EMPTY_NODE = {
  key: -1,
  level: -1,
  data: {}
...
// CONCATENATED MODULE: ./src/tree/tree-node.js




var tree_node_createNamespace = createNamespace("tree-node"),
    tree_node_createComponent = tree_node_createNamespace[0],
    tree_node_bem = tree_node_createNamespace[1];



/* harmony default export */ var tree_node = (tree_node_createComponent({
  components: {
    VlIcon: components_icon,
    VlCheckbox: components_checkbox,
    VlNodeContent: tree_node_content
  },
  props: treeNodeProps,
  ...
  render: function render() {
    ...
    return h("div", {
      ...
      "style": {
        paddingLeft: "".concat((this.node.level - 1) * this.indent, "px")
      }
    }, [h("span", {
      "class": ['vl-tree__expand-icon', {
    ...
    })]), this.showCheckbox ? this.genCheckbox() : '', h("vl-node-content", {
      "attrs": {
        "node": this.node
      }
    })])]);
...
// CONCATENATED MODULE: ./src/components/virtual-list/src/hooks/use-cache.js


var use_cache_useCache = function useCache(perfMode) {
  // eslint-disable-next-line
  var _getItemStyleCache = function _getItemStyleCache(_, __, ___) {
    return {};
  };

  return perfMode ? Object(require["memoize"])(_getItemStyleCache) : memoizeOne(_getItemStyleCache);
};
// CONCATENATED MODULE: ./src/components/virtual-list/src/defaults.js


var _PageKey, _ScrollbarSizeKey, _ScrollbarDirKey;
...
var PageKey = (_PageKey = {}, _defineProperty(_PageKey, HORIZONTAL, 'pageX'), _defineProperty(_PageKey, VERTICAL, 'pageY'), _PageKey);
var ScrollbarSizeKey = (_ScrollbarSizeKey = {}, _defineProperty(_ScrollbarSizeKey, HORIZONTAL, 'height'), _defineProperty(_ScrollbarSizeKey, VERTICAL, 'width'), _ScrollbarSizeKey);
...
// CONCATENATED MODULE: ./src/components/virtual-list/src/hooks/use-wheel.js


var _LayoutKeys; // @ts-nocheck
...
var use_wheel_useWheel = function useWheel(_ref, onWheelDelta) {
  ...
  var hasReachedEdge = function hasReachedEdge(offset) {
    var edgeReached = offset < 0 && atStartEdge.value || offset > 0 && atEndEdge.value;
    return edgeReached;
  };
...
/* harmony default export */ var use_wheel = (use_wheel_useWheel);
...
// CONCATENATED MODULE: ./src/components/virtual-list/src/utils.js

 // @ts-nocheck


var utils_getScrollDir = function getScrollDir(prev, cur) {
  return prev < cur ? FORWARD : BACKWARD;
};
var utils_isHorizontal = function isHorizontal(dir) {
  return dir === LTR || dir === RTL || dir === HORIZONTAL;
};
var utils_isRTL = function isRTL(dir) {
  return dir === RTL;
};
...
var utils_getRelativePos = function getRelativePos(e, layout) {
...
function renderThumbStyle(_ref, layout) {
  ...
  style.msTransform = translate // polyfill
  ;
...
// CONCATENATED MODULE: ./src/components/virtual-list/src/props.js
...
var virtualizedListProps = _objectSpread2({
  /**
   ...
   */
  layout: props_layout,
  initScrollOffset: props_initScrollOffset,

  /**
   * @description describes the total number of the list.
   */
  total: props_total,
  itemSize: props_itemSize
}, virtualizedProps);
var scrollbarSize = {
  type: Number,
  default: 6
...
// CONCATENATED MODULE: ./src/components/virtual-list/src/components/scrollbar.js
...
var scrollbar_createNamespace = createNamespace('scrollbar'),
    scrollbar_createComponent = scrollbar_createNamespace[0],
    scrollbar_bem = scrollbar_createNamespace[1];

var ScrollBar = scrollbar_createComponent({
  ...
  computed: {
    ...
    trackStyle: function trackStyle() {
      ...
      return _ref = {
        position: 'absolute',
        width: "".concat(HORIZONTAL === this.layout ? this.trackSize : this.scrollbarSize, "px"),
        height: "".concat(HORIZONTAL === this.layout ? this.scrollbarSize : this.trackSize, "px")
      }, _defineProperty(_ref, ScrollbarDirKey[this.layout], '2px'), _defineProperty(_ref, "right", '2px'), _defineProperty(_ref, "bottom", '2px'), _defineProperty(_ref, "borderRadius", '4px'), _ref;
    },
    ...
    thumbStyle: function thumbStyle() {
      ...
      var thumb = "".concat(this.thumbSize, "px");
  ...
  watch: {
    scrollFrom: function scrollFrom(v) {
  ...
  methods: {
    attachEvents: function attachEvents() {
      ...
      var thumbEl = this.$refs.thumbRef;
      if (!thumbEl) return;
    ...
    onThumbMouseDown: function onThumbMouseDown(e) {
      ...
      this.state[this.bar.axis] = e.currentTarget[this.bar.offset] - (e[this.bar.client] - e.currentTarget.getBoundingClientRect()[this.bar.direction]);
    ...
    onMouseMove: function onMouseMove(e) {
      ...
      var prevPage = this.state[this.bar.axis];
      if (!prevPage) return;
      cAF(this.frameHandle); // using the current track's offset top/left - the current pointer's clientY/clientX
      // to get the relative position of the pointer to the track.

      var offset = (this.$refs.trackRef.getBoundingClientRect()[this.bar.direction] - e[this.bar.client]) * -1; // find where the thumb was clicked on.

      var thumbClickPosition = this.$refs.thumbRef[this.bar.offset] - prevPage;
      /**
       *  +--------------+                                   +--------------+
       *  |              -  <--------- thumb.offsetTop       |              |
       *  |             |+|             <--+                 |              |
      ...
      var distance = offset - thumbClickPosition; // get how many steps in total.
      ...
      this.frameHandle = rAF(function () {
        _this.state.traveled = Math.max(_this.startGap, Math.min(distance, _this.totalSteps // 2 is the top value
        ));

        _this.$emit('scroll', distance, _this.totalSteps);
      });
    },
    clickTrackHandler: function clickTrackHandler(e) {
      var offset = Math.abs(e.target.getBoundingClientRect()[this.bar.direction] - e[this.bar.client]);
      var thumbHalf = this.$refs.thumbRef[this.bar.offset] / 2;
  ...
  render: function render(h) {
    ...
    return h('div', {
      role: 'presentation',
      ref: 'trackRef',
      class: [scrollbar_bem('virtual'), this.className, (this.alwaysOn || this.state.isDragging) && 'always-on'],
      ...
      on: {
        mousedown: function mousedown(e) {
          ...
          _this2.clickTrackHandler(e);
        },
        touchstartPrevent: this.onThumbMouseDown
      }
    }, [h('div', {
      ref: 'thumbRef',
      class: scrollbar_bem('thumb'),
...
// CONCATENATED MODULE: ./src/components/virtual-list/src/builders/build-list.js
...
var build_list_createNamespace = createNamespace('virtual-list'),
    build_list_createComponent = build_list_createNamespace[0],
    build_list_bem = build_list_createNamespace[1];

var build_list_createList = function createList(_ref) {
  var getOffset = _ref.getOffset,
      getItemSize = _ref.getItemSize,
      getItemOffset = _ref.getItemOffset,
      getEstimatedTotalSize = _ref.getEstimatedTotalSize,
      getStartIndexForOffset = _ref.getStartIndexForOffset,
      getStopIndexForStartIndex = _ref.getStopIndexForStartIndex;
  return build_list_createComponent({
    ...
    computed: {
      itemsToRender: function itemsToRender() {
        ...
        var _this$states = this.states,
            isScrolling = _this$states.isScrolling,
            scrollDir = _this$states.scrollDir,
            scrollOffset = _this$states.scrollOffset;

        if (total === 0) {
          return [0, 0, 0, 0];
        }

        var startIndex = getStartIndexForOffset(this, scrollOffset, this.dynamicSizeCache);
        var stopIndex = getStopIndexForStartIndex(this, startIndex, scrollOffset, this.dynamicSizeCache);
      ...
      windowStyle: function windowStyle() {
        ...
        return [(_ref2 = {
          position: 'relative'
        }, _defineProperty(_ref2, "overflow-".concat(this._isHorizontal.value ? 'x' : 'y'), 'scroll'), _defineProperty(_ref2, "WebkitOverflowScrolling", 'touch'), _defineProperty(_ref2, "willChange", 'transform'), _ref2), {
          direction: this.direction,
          height: isNumber(this.height) ? "".concat(this.height, "px") : this.height,
          width: isNumber(this.width) ? "".concat(this.width, "px") : this.width
        }, this.style];
      },
      innerStyle: function innerStyle() {
        var size = this.estimatedTotalSize;
      ...
      clientSize: function clientSize() {
        return this._isHorizontal ? this.width : this.height;
      },
      getItemStyleCache: function getItemStyleCache() {
        return use_cache_useCache(this.perfMode);
      }
    },
    mounted: function mounted() {
      this.doMounted();
    ...
    methods: {
      onWheel: function onWheel() {
        ...
        return use_wheel({
          ...
          _this.$refs.scrollbarRef.onMouseUp();

          _this.scrollTo(Math.min(_this.states.scrollOffset + offset, _this.estimatedTotalSize - _this.clientSize));
        });
      },
      emitEvents: function emitEvents() {
        ...
        if (total > 0) {
          var _this$itemsToRender = _slicedToArray(this.itemsToRender, 4),
              cacheStart = _this$itemsToRender[0],
              cacheEnd = _this$itemsToRender[1],
              visibleStart = _this$itemsToRender[2],
              visibleEnd = _this$itemsToRender[3];

          this.$emit(ITEM_RENDER_EVT, cacheStart, cacheEnd, visibleStart, visibleEnd);
        }

        var _this$states2 = this.states,
            scrollDir = _this$states2.scrollDir,
            scrollOffset = _this$states2.scrollOffset,
            updateRequested = _this$states2.updateRequested;
      ...
      scrollVertically: function scrollVertically(e) {
        ...
        this.states = _objectSpread2(_objectSpread2({}, _states), {}, {
          isScrolling: true,
          scrollDir: utils_getScrollDir(_states.scrollOffset, scrollOffset),
          scrollOffset: scrollOffset,
          updateRequested: false
        });
        this.$nextTick(this.resetIsScrolling);
      },
      scrollHorizontally: function scrollHorizontally(e) {
      ...
      onScrollbarScroll: function onScrollbarScroll(distanceToGo, totalSteps) {
        var offset = (this.estimatedTotalSize - this.clientSize) / totalSteps * distanceToGo;
        this.scrollTo(Math.min(this.estimatedTotalSize - this.clientSize, offset));
      },
      scrollTo: function scrollTo(offset) {
        ...
        this.states = _objectSpread2(_objectSpread2({}, this.states), {}, {
          scrollOffset: offset,
          scrollDir: utils_getScrollDir(this.states).scrollOffset,
          offset: offset,
      ...
      scrollToItem: function scrollToItem(idx) {
        ...
        var scrollOffset = this.states.scrollOffset;
        idx = Math.max(0, Math.min(idx, this.total - 1));
        this.scrollTo(getOffset(this, idx, alignment, scrollOffset, this.dynamicSizeCache));
      },
      getItemStyle: function getItemStyle(idx) {
        var direction = this.direction,
            itemSize = this.itemSize,
            layout = this.layout;
        var itemStyleCache = this.getItemStyleCache({
          direction: direction,
          itemSize: itemSize,
          layout: layout
        });
        ...
        if (utils_hasOwn(itemStyleCache, String(idx))) {
          style = itemStyleCache[idx];
        } else {
          var offset = getItemOffset(this, idx, this.dynamicSizeCache);
          var size = getItemSize(this, idx, this.dynamicSizeCache);
          var horizontal = this._isHorizontal;
          var isRtl = direction === RTL;
          var offsetHorizontal = horizontal ? offset : 0;
          itemStyleCache[idx] = style = {
            position: 'absolute',
            left: isRtl ? undefined : "".concat(offsetHorizontal, "px"),
            right: isRtl ? "".concat(offsetHorizontal, "px") : undefined,
      ...
      resetIsScrolling: function resetIsScrolling() {
        var _this2 = this; // timer = null


        this.states.isScrolling = false;
        this.$nextTick(function () {
          _this2.getItemStyleCache(-1, null, null);
        });
      },
      resetScrollTop: function resetScrollTop() {
        var window = this.$refs.windowRef;
      ...
      // life cycles
      doMounted: function doMounted() {
        if (!isClient) return;
        var initScrollOffset = this.initScrollOffset;
        var windowElement = this.$refs.windowRef;
      ...
      doUpdated: function doUpdated() {
        var direction = this.direction,
            layout = this.layout;
        var _this$states3 = this.states,
            scrollOffset = _this$states3.scrollOffset,
            updateRequested = _this$states3.updateRequested;
        var windowElement = this.$refs.windowRef;
    ...
    render: function render(h) {
      var _this$itemsToRender2 = _slicedToArray(this.itemsToRender, 2),
          start = _this$itemsToRender2[0],
          end = _this$itemsToRender2[1];
      ...
      if (this.total > 0) {
        var data = this.data,
            useIsScrolling = this.useIsScrolling,
            states = this.states,
      ...
      var scrollbar = h(components_scrollbar, {
        ref: 'scrollbarRef',
        on: {
      ...
      var listContainer = h(Container, {
        class: [build_list_bem('window'), 'vl-scrollbar__content', this.className],
      ...
      return h('div', {
        key: 0,
        class: ['vl-scrollbar', build_list_bem('wrapper'), this.states.scrollbarAlwaysOn ? 'always-on' : '']
      }, [listContainer, scrollbar]);
    }
  });
};

/* harmony default export */ var build_list = (build_list_createList);
// CONCATENATED MODULE: ./src/components/virtual-list/src/components/fixed-size-list.js




var FixedSizeList = build_list({
  ...
  getOffset: function getOffset(_ref4, index, alignment, scrollOffset) {
    var height = _ref4.height,
        ...
        layout = _ref4.layout,
        width = _ref4.width;
    var size = utils_isHorizontal(layout) ? width : height;
  ...
  getStopIndexForStartIndex: function getStopIndexForStartIndex(_ref6, startIndex, scrollOffset) {
    ...
    return Math.max(0, Math.min(total - 1, // because startIndex is inclusive, so in order to prevent array outbound indexing
    // we need to - 1 to prevent outbound behavior
    startIndex + numVisibleItems - 1));
  }
});
/* harmony default export */ var fixed_size_list = (FixedSizeList);
// CONCATENATED MODULE: ./src/components/virtual-list/index.js


// CONCATENATED MODULE: ./node_modules/@sangtian152/stl/dist/stl.mjs
var t=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},stl_e=function(){function e(){this.value={},this.size=0,this.add.apply(this,[].slice.call(arguments))}var r=e.prototype;return r.get=function(){return this.value},r.set=function(){this.clear(),this.add([].slice.call(arguments))},r.notify=function(){var t=this.__ob__;t&&t.dep.notify()},r.add=function(){for(var r=[].slice.call(arguments),n=0;n<r.length;n++){var i=r[n],a=e._v2s.get(i);t(this.value,a)||(this.value[a]=i,this.size++,this.notify())}return this},r.delete=function(){for(var r=[].slice.call(arguments),n=0;n<r.length;n++){var i=e._v2s.get(r[n]);t(this.value,i)&&(delete this.value[i],this.size--,this.notify())}return this},r.has=function(r){return t(this.value,e._v2s.get(r))},r.forEach=function(e,r){for(var n in this.value)t(this.value,n)&&e.call(r,this.value[n])},r.clear=function(){this.value={},this.size=0,this.notify()},e}();stl_e._v2s={next:100,get:function(r){switch(r){case void 0:return"u";case null:return"n";case!0:return"t";case!1:return"f";default:switch(typeof r){case"number":return"#"+r;case"string":return'"'+r;default:return"@"+(t(n=r,i="|**objectid**|")||(n[i]=stl_e._v2s.next++),n[i])}}var n,i}};var r=function(){function t(){this.value=new Array,this.size=0}var e=t.prototype;return e.notify=function(){this.size=this.value.length;var t=this.__ob__;t&&t.dep.notify()},e.clear=function(){this.value=new Array,this.notify()},e.set=function(t,e){this.value.push({key:t,value:e}),this.notify()},e.get=function(t){try{for(var e=0;e<this.value.length;e++)if(this.value[e].key==t)return this.value[e].value}catch(t){return null}},e.delete=function(t){var e=!1;try{for(var r=0;r<this.value.length;r++)if(this.value[r].key==t)return this.value.splice(r,1),this.notify(),!0}catch(t){e=!1}return e},e.forEach=function(t,e){for(var r=this.value.length,n=0;n<r;n++){var i=this.value[n];t.call(e,i.key,i.value,this)}},e.getKey=function(t){try{for(var e=0;e<this.value.length;e++)if(this.value[e].value==t)return this.value[e].key}catch(t){return null}},e.has=function(t){var e=!1;try{for(var r=0;r<this.value.length;r++)this.value[r].key==t&&(e=!0)}catch(t){e=!1}return e},e.containsValue=function(t){var e=!1;try{for(var r=0;r<this.value.length;r++)this.value[r].value==t&&(e=!0)}catch(t){e=!1}return e},e.entries=function(){for(var t=new Array,e=0;e<this.value.length;e++){var r=this.value[e];t.push([r.key,r.value])}return t},e.values=function(){for(var t=new Array,e=0;e<this.value.length;e++)t.push(this.value[e].value);return t},e.keys=function(){for(var t=new Array,e=0;e<this.value.length;e++)t.push(this.value[e].key);return t},t}(),stl_n={JSet:stl_e,JMap:r};/* harmony default export */ var stl = (stl_n);
//# sourceMappingURL=stl.mjs.map
...
var tree_createNamespace = createNamespace("tree"),
    tree_createComponent = tree_createNamespace[0],
    tree_bem = tree_createNamespace[1];




/* harmony default export */ var src_tree = (tree_createComponent({
  components: {
    VlTreeNode: tree_node,
    FixedSizeList: fixed_size_list
  },
  props: treeProps,
  provide: function provide() {
    return _defineProperty({}, ROOT_TREE_INJECTION_KEY, this);
  },
  data: function data() {
    return {
      tree: {},
      currentKey: null,
      checkedKeys: new stl_e(),
      indeterminateKeys: new stl_e(),
      hiddenNodeKeySet: new stl_e(),
      hiddenExpandIconKeySet: new stl_e(),
      expandedKeySet: construct_construct(stl_e, _toConsumableArray(this.defaultExpandedKeys))
    };
  },
  computed: {
    ...
    flattenTree: function flattenTree() {
      var expandedKeys = this.expandedKeySet;
      var hiddenKeys = this.hiddenNodeKeySet;
      var flattenNodes = [];
      var nodes = this.tree && this.tree.treeNodes || [];
  ...
  watch: {
    ...
    defaultExpandedKeys: function defaultExpandedKeys(val) {
      this.expandedKeySet = construct_construct(stl_e, _toConsumableArray(val));
    },
    tree: {
      handler: function handler() {
        ...
        this.$nextTick(function () {
          _this._setCheckedKeys(_this.defaultCheckedKeys);
        });
      },
      immediate: true
    }
  ...
  methods: {
    ...
    filter: function filter(query) {
      var keys = this.doFilter(query);

      if (keys) {
        this.expandedKeySet = keys;
      }
    },
    doFilter: function doFilter(query) {
      if (!this.filterable) {
        return;
      }

      var expandKeySet = new stl_e();
      var hiddenExpandIconKeys = this.hiddenExpandIconKeySet;
      var hiddenKeys = this.hiddenNodeKeySet;
      var family = [];
      var nodes = this.tree.treeNodes || [];
      var filter = this.filterMethod;
      hiddenKeys.clear();
    ...
    isForceHiddenExpandIcon: function isForceHiddenExpandIcon(node) {
    ...
    getDisabled: function getDisabled(node) {
    ...
    handleNodeClick: function handleNodeClick(node, e) {
    ...
    setData: function setData(data) {
      ...
      this.$nextTick(function () {
        _this2.tree = _this2.createTree(data);
      });
    },
    ...
    updateCheckedKeys: function updateCheckedKeys() {
      ...
      var _this$tree = this.tree,
          levelTreeNodeMap = _this$tree.levelTreeNodeMap,
          maxLevel = _this$tree.maxLevel;
      var checkedKeySet = this.checkedKeys;
      var indeterminateKeySet = new Set(); // It is easier to determine the indeterminate state by
      ...
      for (var level = maxLevel - 1; level >= 1; --level) {
        ...
        nodes.forEach(function (node) {
          ...
          if (children) {
            ...
            var allChecked = true; // Whether a child node is selected
    ...
    afterNodeCheck: function afterNodeCheck(node, checked) {
      var _this$getChecked = this.getChecked(),
          checkedNodes = _this$getChecked.checkedNodes,
          checkedKeys = _this$getChecked.checkedKeys;

      var _this$getHalfChecked = this.getHalfChecked(),
          halfCheckedNodes = _this$getHalfChecked.halfCheckedNodes,
          halfCheckedKeys = _this$getHalfChecked.halfCheckedKeys;
    ...
    getChecked: function getChecked() {
      ...
      if (this.tree && this.showCheckbox) {
        var treeNodeMap = this.tree.treeNodeMap;
        this.checkedKeys.forEach(function (key) {
          var node = treeNodeMap.get(key);
    ...
    getHalfChecked: function getHalfChecked() {
      var halfCheckedNodes = [];
      var halfCheckedKeys = [];

      if (this.tree && this.showCheckbox) {
        var treeNodeMap = this.tree.treeNodeMap;
        this.indeterminateKeys.forEach(function (key) {
          var node = treeNodeMap.get(key);
    ...
    setChecked: function setChecked(key, isChecked) {
      if (this.tree && this.showCheckbox) {
        var node = this.tree.treeNodeMap.get(key);
    ...
    _setCheckedKeys: function _setCheckedKeys(keys) {
      if (this.tree) {
        var treeNodeMap = this.tree.treeNodeMap;
    ...
    genTreeNode: function genTreeNode(_ref2) {
      var node = _ref2.node,
          style = _ref2.style;
      var h = this.$createElement;
      return h("vl-tree-node", {
        "key": node.key,
        "style": style,
        "attrs": {
          "node": node,
    ...
    genFixedSizeList: function genFixedSizeList() {
      var h = this.$createElement;
      return h("fixed-size-list", {
        "attrs": {
  ...
  render: function render() {
    var h = arguments[0];
    return h("div", {
      "class": [tree_bem(), _defineProperty({}, 'highlight-current', this.highlightCurrent)],
      "attrs": {
        "role": "tree"
      }
...
// EXTERNAL MODULE: ./src/styles/checkbox.scss
var styles_checkbox = __webpack_require__("8ac8");
...
//# sourceMappingURL=vl-tree.umd.js.map