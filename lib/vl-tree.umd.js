...
module.exports = JSON.parse("{\"name\":\"@sangtian152/virtual-tree\",\"version\":\"0.2.5\",\"private\":false,\"main\":\"lib/vl-tree.common.js\",\"license\":\"MIT\",\"homepage\":\"https://sangtian152.github.io/virtual-tree\",\"keywords\":[\"tree\",\"vl-tree\",\"virtual-tree\",\"vue\",\"虚拟化树控件\"],\"scripts\":{\"dev\":\"vuepress dev docs\",\"build\":\"npm run build:docs && npm run build:lib\",\"lint\":\"vue-cli-service lint\",\"build:docs\":\"vuepress build docs\",\"build:lib\":\"vue-cli-service build --target lib --name vl-tree --dest lib src/index.js\"},\"dependencies\":{\"@sangtian152/stl\":\"^1.0.0\",\"core-js\":\"^3.6.5\",\"lodash-unified\":\"^1.0.2\",\"memoize-one\":\"^6.0.0\"},\"peerDependencies\":{\"vue\":\"^2.6.11\"},\"devDependencies\":{\"@vue/cli-plugin-babel\":\"~4.5.15\",\"@vue/cli-plugin-eslint\":\"~4.5.15\",\"@vue/cli-service\":\"~4.5.15\",\"async-validator\":\"^1.11.5\",\"babel-eslint\":\"^10.1.0\",\"clipboard\":\"^2.0.11\",\"element-ui\":\"^2.15.9\",\"eslint\":\"^6.7.2\",\"eslint-plugin-vue\":\"^6.2.2\",\"sass\":\"^1.53.0\",\"sass-loader\":\"^8.0.2\",\"view-design\":\"^4.7.0\",\"vue\":\"^2.6.14\",\"vue-template-compiler\":\"^2.6.11\",\"vuepress\":\"^1.9.7\"},\"eslintConfig\":{\"root\":true,\"env\":{\"node\":true},\"extends\":[\"plugin:vue/essential\",\"eslint:recommended\"],\"parserOptions\":{\"parser\":\"babel-eslint\"},\"rules\":{}},\"browserslist\":[\"> 1%\",\"last 2 versions\",\"Chrome 40.0\",\"ie >= 11\"]}");
...
var t=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},stl_e=function(){function e(t){this.value={},this.size=0,this.add.call(this,t)}var n=e.prototype;return n.get=function(){return this.value},n.set=function(t){this.clear(),this.add(t)},n.notify=function(){var t=this.__ob__;t&&t.dep.notify()},n.add=function(n){n=[].concat(n);for(var r=0;r<n.length;r++){var i=n[r],a=e._v2s.get(i);t(this.value,a)||(this.value[a]=i,this.size++,this.notify())}return this},n.delete=function(){for(var n=[].slice.call(arguments),r=0;r<n.length;r++){var i=e._v2s.get(n[r]);t(this.value,i)&&(delete this.value[i],this.size--,this.notify())}return this},n.has=function(n){return t(this.value,e._v2s.get(n))},n.forEach=function(e,n){for(var r in this.value)t(this.value,r)&&e.call(n,this.value[r])},n.clear=function(){this.value={},this.size=0,this.notify()},e}();stl_e._v2s={next:100,get:function(n){switch(n){case void 0:return"u";case null:return"n";case!0:return"t";case!1:return"f";default:switch(typeof n){case"number":return"#"+n;case"string":return'"'+n;default:return"@"+(t(r=n,i="|**objectid**|")||(r[i]=stl_e._v2s.next++),r[i])}}var r,i}};var stl_n=function(){function t(){this.value=new Array,this.size=0}var e=t.prototype;return e.notify=function(){this.size=this.value.length;var t=this.__ob__;t&&t.dep.notify()},e.clear=function(){this.value=new Array,this.notify()},e.set=function(t,e){this.value.push({key:t,value:e}),this.notify()},e.get=function(t){try{for(var e=0;e<this.value.length;e++)if(this.value[e].key==t)return this.value[e].value}catch(t){return null}},e.delete=function(t){var e=!1;try{for(var n=0;n<this.value.length;n++)if(this.value[n].key==t)return this.value.splice(n,1),this.notify(),!0}catch(t){e=!1}return e},e.forEach=function(t,e){for(var n=this.value.length,r=0;r<n;r++){var i=this.value[r];t.call(e,i.key,i.value,this)}},e.getKey=function(t){try{for(var e=0;e<this.value.length;e++)if(this.value[e].value==t)return this.value[e].key}catch(t){return null}},e.has=function(t){var e=!1;try{for(var n=0;n<this.value.length;n++)this.value[n].key==t&&(e=!0)}catch(t){e=!1}return e},e.containsValue=function(t){var e=!1;try{for(var n=0;n<this.value.length;n++)this.value[n].value==t&&(e=!0)}catch(t){e=!1}return e},e.entries=function(){for(var t=new Array,e=0;e<this.value.length;e++){var n=this.value[e];t.push([n.key,n.value])}return t},e.values=function(){for(var t=new Array,e=0;e<this.value.length;e++)t.push(this.value[e].value);return t},e.keys=function(){for(var t=new Array,e=0;e<this.value.length;e++)t.push(this.value[e].key);return t},t}(),r={JSet:stl_e,JMap:stl_n};/* harmony default export */ var stl = (r);
...
/* harmony default export */ var src_tree = (tree_createComponent({
  ...
  data: function data() {
    return {
      ...
      expandedKeySet: new stl_e(this.defaultExpandedKeys)
    };
  },
  computed: {
  ...
  watch: {
    ...
    defaultExpandedKeys: function defaultExpandedKeys(val) {
      this.expandedKeySet = new stl_e(val);
    },
    tree: {
